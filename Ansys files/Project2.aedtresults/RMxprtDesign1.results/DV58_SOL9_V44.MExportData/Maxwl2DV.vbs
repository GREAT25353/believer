...
if (oDefinitionManager.DoesMaterialExist("M19_24G_2DSF2.058")) then
else
oDefinitionManager.AddMaterial Array("NAME:M19_24G_2DSF2.058", _
  "CoordinateSystemType:=", "Cartesian", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), Array("NAME:permeability", "property_type:=", _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", Array(_
  "NAME:BHCoordinates", Array("NAME:Coordinate", "X:=", 0, "Y:=", 0), Array(_
  "NAME:Coordinate", "X:=", 22.28, "Y:=", 0.102887), Array("NAME:Coordinate", _
  "X:=", 25.46, "Y:=", 0.205799), Array("NAME:Coordinate", "X:=", 31.83, _
  "Y:=", 0.308708), Array("NAME:Coordinate", "X:=", 47.74, "Y:=", 0.740937), _
  Array("NAME:Coordinate", "X:=", 63.66, "Y:=", 1.11142), Array(_
  "NAME:Coordinate", "X:=", 79.57, "Y:=", 1.33781), Array("NAME:Coordinate", _
  "X:=", 159.15, "Y:=", 2.03754), Array("NAME:Coordinate", "X:=", 318.3, _
  "Y:=", 2.46958), Array("NAME:Coordinate", "X:=", 477.46, "Y:=", 2.63403), _
  Array("NAME:Coordinate", "X:=", 636.61, "Y:=", 2.73674), Array(_
  "NAME:Coordinate", "X:=", 795.77, "Y:=", 2.79828), Array("NAME:Coordinate", _
  "X:=", 1591.5, "Y:=", 2.96188), Array("NAME:Coordinate", "X:=", 3183, "Y:=", _
  3.12443), Array("NAME:Coordinate", "X:=", 4774.6, "Y:=", 3.24582), Array(_
  "NAME:Coordinate", "X:=", 6366.1, "Y:=", 3.34662), Array("NAME:Coordinate", _
  "X:=", 7957.7, "Y:=", 3.42683), Array("NAME:Coordinate", "X:=", 15915, _
  "Y:=", 3.68383), Array("NAME:Coordinate", "X:=", 31830, "Y:=", 3.8685), _
  Array("NAME:Coordinate", "X:=", 111407, "Y:=", 3.9685), Array(_
  "NAME:Coordinate", "X:=", 190984, "Y:=", 4.0685), Array("NAME:Coordinate", _
  "X:=", 350138, "Y:=", 4.2685), Array("NAME:Coordinate", "X:=", 509292, _
  "Y:=", 4.46851), Array("NAME:Coordinate", "X:=", 2.10083e+06, "Y:=", _
  6.46852))), Array("NAME:core_loss_type", "property_type:=", _
  "ChoiceProperty", "Choice:=", "Electrical Steel"), "core_loss_kh:=", _
  79.7733, "core_loss_kc:=", 0.631579, "core_loss_ke:=", 1.19887, _
  "conductivity:=", 1.96e+06, "mass_density:=", 15746.2) 
end if
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF2.167_N")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF2.167_N", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "2.1666", "conductivity:=", "0", _
...
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF2.167_S")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF2.167_S", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "2.1666", "conductivity:=", "0", _
  "mass_density:=", "0", Array("NAME:magnetic_coercivity", "property_type:=", _
  "VectorProperty", "Magnitude:=", "-690007A_per_meter", "DirComp1:=", "-1", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "M19_24G_2DSF2.058", "SolveInside:=", true) 
On Error Resume Next
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/Band", "Version:=", "12.1", "NoOfParameters:=", 7, _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "PartCoordinateSystem:=", "Global", "MaterialName:=", "M19_24G_2DSF2.058", _
  "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Global", "MaterialName:=", "XG196/96_2DSF2.167_N", "SolveInside:=", true) 
On Error Resume Next
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "2781.59rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.000375164, _
  "Load Torque:=", "if(speed<151.52, -0.0239643*speed, -550.184/speed)", _
  "Objects:=", Array("Band"))
