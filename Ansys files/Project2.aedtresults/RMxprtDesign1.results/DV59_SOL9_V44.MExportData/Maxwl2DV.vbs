...
if (oDefinitionManager.DoesMaterialExist("M19_24G_2DSF1.992")) then
else
oDefinitionManager.AddMaterial Array("NAME:M19_24G_2DSF1.992", _
  "CoordinateSystemType:=", "Cartesian", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), Array("NAME:permeability", "property_type:=", _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", Array(_
  "NAME:BHCoordinates", Array("NAME:Coordinate", "X:=", 0, "Y:=", 0), Array(_
  "NAME:Coordinate", "X:=", 22.28, "Y:=", 0.099569), Array("NAME:Coordinate", _
  "X:=", 25.46, "Y:=", 0.199162), Array("NAME:Coordinate", "X:=", 31.83, _
  "Y:=", 0.298751), Array("NAME:Coordinate", "X:=", 47.74, "Y:=", 0.717037), _
  Array("NAME:Coordinate", "X:=", 63.66, "Y:=", 1.07557), Array(_
  "NAME:Coordinate", "X:=", 79.57, "Y:=", 1.29466), Array("NAME:Coordinate", _
  "X:=", 159.15, "Y:=", 1.97182), Array("NAME:Coordinate", "X:=", 318.3, _
  "Y:=", 2.38993), Array("NAME:Coordinate", "X:=", 477.46, "Y:=", 2.54908), _
  Array("NAME:Coordinate", "X:=", 636.61, "Y:=", 2.64848), Array(_
  "NAME:Coordinate", "X:=", 795.77, "Y:=", 2.70804), Array("NAME:Coordinate", _
  "X:=", 1591.5, "Y:=", 2.8664), Array("NAME:Coordinate", "X:=", 3183, "Y:=", _
  3.02377), Array("NAME:Coordinate", "X:=", 4774.6, "Y:=", 3.14131), Array(_
  "NAME:Coordinate", "X:=", 6366.1, "Y:=", 3.23892), Array("NAME:Coordinate", _
  "X:=", 7957.7, "Y:=", 3.31661), Array("NAME:Coordinate", "X:=", 15915, _
  "Y:=", 3.56565), Array("NAME:Coordinate", "X:=", 31830, "Y:=", 3.745), _
  Array("NAME:Coordinate", "X:=", 111407, "Y:=", 3.845), Array(_
  "NAME:Coordinate", "X:=", 190984, "Y:=", 3.945), Array("NAME:Coordinate", _
  "X:=", 350138, "Y:=", 4.145), Array("NAME:Coordinate", "X:=", 509292, "Y:=", _
  4.345), Array("NAME:Coordinate", "X:=", 2.10083e+06, "Y:=", 6.34502))), _
  Array("NAME:core_loss_type", "property_type:=", "ChoiceProperty", _
  "Choice:=", "Electrical Steel"), "core_loss_kh:=", 82.4324, _
  "core_loss_kc:=", 0.652632, "core_loss_ke:=", 1.21868, "conductivity:=", _
  1.96e+06, "mass_density:=", 15238.3) 
end if
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF2.097_N")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF2.097_N", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "2.09671", "conductivity:=", "0", _
...
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF2.097_S")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF2.097_S", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "2.09671", "conductivity:=", "0", _
  "mass_density:=", "0", Array("NAME:magnetic_coercivity", "property_type:=", _
  "VectorProperty", "Magnitude:=", "-690007A_per_meter", "DirComp1:=", "-1", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "M19_24G_2DSF1.992", "SolveInside:=", true) 
On Error Resume Next
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/Band", "Version:=", "12.1", "NoOfParameters:=", 7, _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "PartCoordinateSystem:=", "Global", "MaterialName:=", "M19_24G_2DSF1.992", _
  "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Global", "MaterialName:=", "XG196/96_2DSF2.097_N", "SolveInside:=", true) 
On Error Resume Next
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "2699.24rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.000393242, _
  "Load Torque:=", "if(speed<147.129, -0.0254156*speed, -550.173/speed)", _
  "Objects:=", Array("Band"))
