...
oDefinitionManager.AddMaterial Array("NAME:XG196/96_3DSF1.000_N", _
  ...
  "VectorProperty", "Magnitude:=", "-689987A_per_meter", "DirComp1:=", "1", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Value:=", "123.3112365985873mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "DiaYoke", "Value:=", "120mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "31mm"), Array("NAME:Pair", "Name:=", "Skew", "Value:=", "0deg"), _
  ...
  "123.3112365985873mm"), Array("NAME:Pair", "Name:=", "InfoCore", "Value:=", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  Array("NAME:Pair", "Name:=", "LenRegion", "Value:=", "123.3112365985873mm"), _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "LenRegion", "Value:=", "123.3112365985873mm"), Array("NAME:Pair", "Name:=", _
