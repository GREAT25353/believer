...
if (oDefinitionManager.DoesMaterialExist("M19_24G_2DSF1.930")) then
else
oDefinitionManager.AddMaterial Array("NAME:M19_24G_2DSF1.930", _
  "CoordinateSystemType:=", "Cartesian", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), Array("NAME:permeability", "property_type:=", _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", Array(_
  "NAME:BHCoordinates", Array("NAME:Coordinate", "X:=", 0, "Y:=", 0), Array(_
  "NAME:Coordinate", "X:=", 22.28, "Y:=", 0.0964583), Array("NAME:Coordinate", _
  "X:=", 25.46, "Y:=", 0.192939), Array("NAME:Coordinate", "X:=", 31.83, _
  "Y:=", 0.289416), Array("NAME:Coordinate", "X:=", 47.74, "Y:=", 0.694632), _
  Array("NAME:Coordinate", "X:=", 63.66, "Y:=", 1.04196), Array(_
  "NAME:Coordinate", "X:=", 79.57, "Y:=", 1.2542), Array("NAME:Coordinate", _
  "X:=", 159.15, "Y:=", 1.9102), Array("NAME:Coordinate", "X:=", 318.3, "Y:=", _
  2.31525), Array("NAME:Coordinate", "X:=", 477.46, "Y:=", 2.46944), Array(_
  "NAME:Coordinate", "X:=", 636.61, "Y:=", 2.56574), Array("NAME:Coordinate", _
  "X:=", 795.77, "Y:=", 2.62345), Array("NAME:Coordinate", "X:=", 1591.5, _
  "Y:=", 2.77689), Array("NAME:Coordinate", "X:=", 3183, "Y:=", 2.92941), _
  Array("NAME:Coordinate", "X:=", 4774.6, "Y:=", 3.04333), Array(_
  "NAME:Coordinate", "X:=", 6366.1, "Y:=", 3.13795), Array("NAME:Coordinate", _
  "X:=", 7957.7, "Y:=", 3.21328), Array("NAME:Coordinate", "X:=", 15915, _
  "Y:=", 3.45484), Array("NAME:Coordinate", "X:=", 31830, "Y:=", 3.62922), _
  Array("NAME:Coordinate", "X:=", 111407, "Y:=", 3.72922), Array(_
  "NAME:Coordinate", "X:=", 190984, "Y:=", 3.82922), Array("NAME:Coordinate", _
  "X:=", 350138, "Y:=", 4.02922), Array("NAME:Coordinate", "X:=", 509292, _
  "Y:=", 4.22922), Array("NAME:Coordinate", "X:=", 2.10083e+06, "Y:=", _
  6.22923))), Array("NAME:core_loss_type", "property_type:=", _
  "ChoiceProperty", "Choice:=", "Electrical Steel"), "core_loss_kh:=", _
  85.0915, "core_loss_kc:=", 0.673684, "core_loss_ke:=", 1.23818, _
  "conductivity:=", 1.96e+06, "mass_density:=", 14762.1) 
end if
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF2.031_N")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF2.031_N", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "2.03119", "conductivity:=", "0", _
...
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF2.031_S")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF2.031_S", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "2.03119", "conductivity:=", "0", _
  "mass_density:=", "0", Array("NAME:magnetic_coercivity", "property_type:=", _
  "VectorProperty", "Magnitude:=", "-690007A_per_meter", "DirComp1:=", "-1", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "M19_24G_2DSF1.930", "SolveInside:=", true) 
On Error Resume Next
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/Band", "Version:=", "12.1", "NoOfParameters:=", 7, _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "PartCoordinateSystem:=", "Global", "MaterialName:=", "M19_24G_2DSF1.930", _
  "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Global", "MaterialName:=", "XG196/96_2DSF2.031_N", "SolveInside:=", true) 
On Error Resume Next
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "2621.89rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.00041155, _
  "Load Torque:=", "if(speed<143.002, -0.0269032*speed, -550.161/speed)", _
  "Objects:=", Array("Band"))
