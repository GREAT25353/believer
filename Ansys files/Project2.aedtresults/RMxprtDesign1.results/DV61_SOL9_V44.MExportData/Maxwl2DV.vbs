...
if (oDefinitionManager.DoesMaterialExist("M19_24G_2DSF1.871")) then
else
oDefinitionManager.AddMaterial Array("NAME:M19_24G_2DSF1.871", _
  "CoordinateSystemType:=", "Cartesian", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), Array("NAME:permeability", "property_type:=", _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", Array(_
  "NAME:BHCoordinates", Array("NAME:Coordinate", "X:=", 0, "Y:=", 0), Array(_
  "NAME:Coordinate", "X:=", 22.28, "Y:=", 0.0935362), Array("NAME:Coordinate", _
  "X:=", 25.46, "Y:=", 0.187093), Array("NAME:Coordinate", "X:=", 31.83, _
  "Y:=", 0.280647), Array("NAME:Coordinate", "X:=", 47.74, "Y:=", 0.673584), _
  Array("NAME:Coordinate", "X:=", 63.66, "Y:=", 1.01038), Array(_
  "NAME:Coordinate", "X:=", 79.57, "Y:=", 1.2162), Array("NAME:Coordinate", _
  "X:=", 159.15, "Y:=", 1.85233), Array("NAME:Coordinate", "X:=", 318.3, _
  "Y:=", 2.24511), Array("NAME:Coordinate", "X:=", 477.46, "Y:=", 2.39463), _
  Array("NAME:Coordinate", "X:=", 636.61, "Y:=", 2.48802), Array(_
  "NAME:Coordinate", "X:=", 795.77, "Y:=", 2.54398), Array("NAME:Coordinate", _
  "X:=", 1591.5, "Y:=", 2.6928), Array("NAME:Coordinate", "X:=", 3183, "Y:=", _
  2.84076), Array("NAME:Coordinate", "X:=", 4774.6, "Y:=", 2.95129), Array(_
  "NAME:Coordinate", "X:=", 6366.1, "Y:=", 3.04311), Array("NAME:Coordinate", _
  "X:=", 7957.7, "Y:=", 3.11621), Array("NAME:Coordinate", "X:=", 15915, _
  "Y:=", 3.35076), Array("NAME:Coordinate", "X:=", 31830, "Y:=", 3.52046), _
  Array("NAME:Coordinate", "X:=", 111407, "Y:=", 3.62046), Array(_
  "NAME:Coordinate", "X:=", 190984, "Y:=", 3.72046), Array("NAME:Coordinate", _
  "X:=", 350138, "Y:=", 3.92046), Array("NAME:Coordinate", "X:=", 509292, _
  "Y:=", 4.12046), Array("NAME:Coordinate", "X:=", 2.10083e+06, "Y:=", _
  6.12047))), Array("NAME:core_loss_type", "property_type:=", _
  "ChoiceProperty", "Choice:=", "Electrical Steel"), "core_loss_kh:=", _
  87.7506, "core_loss_kc:=", 0.694737, "core_loss_ke:=", 1.25738, _
  "conductivity:=", 1.96e+06, "mass_density:=", 14314.8) 
end if
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.970_N")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.970_N", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.96964", "conductivity:=", "0", _
...
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.970_S")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.970_S", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.96964", "conductivity:=", "0", _
  "mass_density:=", "0", Array("NAME:magnetic_coercivity", "property_type:=", _
  "VectorProperty", "Magnitude:=", "-690007A_per_meter", "DirComp1:=", "-1", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "M19_24G_2DSF1.871", "SolveInside:=", true) 
On Error Resume Next
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/Band", "Version:=", "12.1", "NoOfParameters:=", 7, _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "PartCoordinateSystem:=", "Global", "MaterialName:=", "M19_24G_2DSF1.871", _
  "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Global", "MaterialName:=", "XG196/96_2DSF1.970_N", "SolveInside:=", true) 
On Error Resume Next
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "2549.25rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.000429963, _
  "Load Torque:=", "if(speed<139.132, -0.0284199*speed, -550.147/speed)", _
  "Objects:=", Array("Band"))
