...
if (oDefinitionManager.DoesMaterialExist("M19_24G_2DSF1.816")) then
else
oDefinitionManager.AddMaterial Array("NAME:M19_24G_2DSF1.816", _
  "CoordinateSystemType:=", "Cartesian", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), Array("NAME:permeability", "property_type:=", _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", Array(_
  "NAME:BHCoordinates", Array("NAME:Coordinate", "X:=", 0, "Y:=", 0), Array(_
  "NAME:Coordinate", "X:=", 22.28, "Y:=", 0.090786), Array("NAME:Coordinate", _
  "X:=", 25.46, "Y:=", 0.181592), Array("NAME:Coordinate", "X:=", 31.83, _
  "Y:=", 0.272394), Array("NAME:Coordinate", "X:=", 47.74, "Y:=", 0.653775), _
  Array("NAME:Coordinate", "X:=", 63.66, "Y:=", 0.98067), Array(_
  "NAME:Coordinate", "X:=", 79.57, "Y:=", 1.18043), Array("NAME:Coordinate", _
  "X:=", 159.15, "Y:=", 1.79785), Array("NAME:Coordinate", "X:=", 318.3, _
  "Y:=", 2.17909), Array("NAME:Coordinate", "X:=", 477.46, "Y:=", 2.32422), _
  Array("NAME:Coordinate", "X:=", 636.61, "Y:=", 2.41486), Array(_
  "NAME:Coordinate", "X:=", 795.77, "Y:=", 2.46918), Array("NAME:Coordinate", _
  "X:=", 1591.5, "Y:=", 2.61366), Array("NAME:Coordinate", "X:=", 3183, "Y:=", _
  2.75732), Array("NAME:Coordinate", "X:=", 4774.6, "Y:=", 2.86466), Array(_
  "NAME:Coordinate", "X:=", 6366.1, "Y:=", 2.95384), Array("NAME:Coordinate", _
  "X:=", 7957.7, "Y:=", 3.02485), Array("NAME:Coordinate", "X:=", 15915, _
  "Y:=", 3.25279), Array("NAME:Coordinate", "X:=", 31830, "Y:=", 3.41809), _
  Array("NAME:Coordinate", "X:=", 111407, "Y:=", 3.51809), Array(_
  "NAME:Coordinate", "X:=", 190984, "Y:=", 3.61809), Array("NAME:Coordinate", _
  "X:=", 350138, "Y:=", 3.81809), Array("NAME:Coordinate", "X:=", 509292, _
  "Y:=", 4.01809), Array("NAME:Coordinate", "X:=", 2.10083e+06, "Y:=", 6.0181))), _
  Array("NAME:core_loss_type", "property_type:=", "ChoiceProperty", _
  "Choice:=", "Electrical Steel"), "core_loss_kh:=", 90.4097, _
  "core_loss_kc:=", 0.715789, "core_loss_ke:=", 1.27629, "conductivity:=", _
  1.96e+06, "mass_density:=", 13893.8) 
end if
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.912_N")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.912_N", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.91171", "conductivity:=", "0", _
...
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.912_S")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.912_S", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.91171", "conductivity:=", "0", _
  "mass_density:=", "0", Array("NAME:magnetic_coercivity", "property_type:=", _
  "VectorProperty", "Magnitude:=", "-690007A_per_meter", "DirComp1:=", "-1", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "M19_24G_2DSF1.816", "SolveInside:=", true) 
On Error Resume Next
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/Band", "Version:=", "12.1", "NoOfParameters:=", 7, _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "PartCoordinateSystem:=", "Global", "MaterialName:=", "M19_24G_2DSF1.816", _
  "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Global", "MaterialName:=", "XG196/96_2DSF1.912_N", "SolveInside:=", true) 
On Error Resume Next
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "2480.7rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.000448591, _
  "Load Torque:=", "if(speed<135.481, -0.0299715*speed, -550.133/speed)", _
  "Objects:=", Array("Band"))
