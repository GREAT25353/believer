...
if (oDefinitionManager.DoesMaterialExist("M19_24G_2DSF1.715")) then
else
oDefinitionManager.AddMaterial Array("NAME:M19_24G_2DSF1.715", _
  "CoordinateSystemType:=", "Cartesian", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), Array("NAME:permeability", "property_type:=", _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", Array(_
  "NAME:BHCoordinates", Array("NAME:Coordinate", "X:=", 0, "Y:=", 0), Array(_
  "NAME:Coordinate", "X:=", 22.28, "Y:=", 0.0857439), Array("NAME:Coordinate", _
  "X:=", 25.46, "Y:=", 0.171505), Array("NAME:Coordinate", "X:=", 31.83, _
  "Y:=", 0.257263), Array("NAME:Coordinate", "X:=", 47.74, "Y:=", 0.617457), _
  Array("NAME:Coordinate", "X:=", 63.66, "Y:=", 0.926193), Array(_
  "NAME:Coordinate", "X:=", 79.57, "Y:=", 1.11486), Array("NAME:Coordinate", _
  "X:=", 159.15, "Y:=", 1.69798), Array("NAME:Coordinate", "X:=", 318.3, _
  "Y:=", 2.05805), Array("NAME:Coordinate", "X:=", 477.46, "Y:=", 2.19513), _
  Array("NAME:Coordinate", "X:=", 636.61, "Y:=", 2.28075), Array(_
  "NAME:Coordinate", "X:=", 795.77, "Y:=", 2.33206), Array("NAME:Coordinate", _
  "X:=", 1591.5, "Y:=", 2.46857), Array("NAME:Coordinate", "X:=", 3183, "Y:=", _
  2.60436), Array("NAME:Coordinate", "X:=", 4774.6, "Y:=", 2.70585), Array(_
  "NAME:Coordinate", "X:=", 6366.1, "Y:=", 2.79018), Array("NAME:Coordinate", _
  "X:=", 7957.7, "Y:=", 2.85736), Array("NAME:Coordinate", "X:=", 15915, _
  "Y:=", 3.07319), Array("NAME:Coordinate", "X:=", 31830, "Y:=", 3.23042), _
  Array("NAME:Coordinate", "X:=", 111407, "Y:=", 3.33042), Array(_
  "NAME:Coordinate", "X:=", 190984, "Y:=", 3.43042), Array("NAME:Coordinate", _
  "X:=", 350138, "Y:=", 3.63042), Array("NAME:Coordinate", "X:=", 509292, _
  "Y:=", 3.83042), Array("NAME:Coordinate", "X:=", 2.10083e+06, "Y:=", _
  5.83043))), Array("NAME:core_loss_type", "property_type:=", _
  "ChoiceProperty", "Choice:=", "Electrical Steel"), "core_loss_kh:=", _
  95.7279, "core_loss_kc:=", 0.757895, "core_loss_ke:=", 1.31329, _
  "conductivity:=", 1.96e+06, "mass_density:=", 13121.9) 
end if
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.806_N")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.806_N", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.8055", "conductivity:=", "0", _
...
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.806_S")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.806_S", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.8055", "conductivity:=", "0", _
  "mass_density:=", "0", Array("NAME:magnetic_coercivity", "property_type:=", _
  "VectorProperty", "Magnitude:=", "-690007A_per_meter", "DirComp1:=", "-1", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "M19_24G_2DSF1.715", "SolveInside:=", true) 
On Error Resume Next
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/Band", "Version:=", "12.1", "NoOfParameters:=", 7, _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "PartCoordinateSystem:=", "Global", "MaterialName:=", "M19_24G_2DSF1.715", _
  "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Global", "MaterialName:=", "XG196/96_2DSF1.806_N", "SolveInside:=", true) 
On Error Resume Next
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "2357.07rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.000485069, _
  "Load Torque:=", "if(speed<128.903, -0.0330788*speed, -549.634/speed)", _
  "Objects:=", Array("Band"))
