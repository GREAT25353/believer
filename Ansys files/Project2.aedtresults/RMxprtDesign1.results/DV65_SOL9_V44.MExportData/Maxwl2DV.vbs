...
if (oDefinitionManager.DoesMaterialExist("M19_24G_2DSF1.669")) then
else
oDefinitionManager.AddMaterial Array("NAME:M19_24G_2DSF1.669", _
  "CoordinateSystemType:=", "Cartesian", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), Array("NAME:permeability", "property_type:=", _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", Array(_
  "NAME:BHCoordinates", Array("NAME:Coordinate", "X:=", 0, "Y:=", 0), Array(_
  "NAME:Coordinate", "X:=", 22.28, "Y:=", 0.0834272), Array("NAME:Coordinate", _
  "X:=", 25.46, "Y:=", 0.16687), Array("NAME:Coordinate", "X:=", 31.83, "Y:=", _
  0.250311), Array("NAME:Coordinate", "X:=", 47.74, "Y:=", 0.600771), Array(_
  "NAME:Coordinate", "X:=", 63.66, "Y:=", 0.901163), Array("NAME:Coordinate", _
  "X:=", 79.57, "Y:=", 1.08473), Array("NAME:Coordinate", "X:=", 159.15, _
  "Y:=", 1.6521), Array("NAME:Coordinate", "X:=", 318.3, "Y:=", 2.00244), _
  Array("NAME:Coordinate", "X:=", 477.46, "Y:=", 2.13581), Array(_
  "NAME:Coordinate", "X:=", 636.61, "Y:=", 2.21913), Array("NAME:Coordinate", _
  "X:=", 795.77, "Y:=", 2.26906), Array("NAME:Coordinate", "X:=", 1591.5, _
  "Y:=", 2.40191), Array("NAME:Coordinate", "X:=", 3183, "Y:=", 2.53408), _
  Array("NAME:Coordinate", "X:=", 4774.6, "Y:=", 2.63288), Array(_
  "NAME:Coordinate", "X:=", 6366.1, "Y:=", 2.71499), Array("NAME:Coordinate", _
  "X:=", 7957.7, "Y:=", 2.78041), Array("NAME:Coordinate", "X:=", 15915, _
  "Y:=", 2.99068), Array("NAME:Coordinate", "X:=", 31830, "Y:=", 3.14419), _
  Array("NAME:Coordinate", "X:=", 111407, "Y:=", 3.24419), Array(_
  "NAME:Coordinate", "X:=", 190984, "Y:=", 3.34419), Array("NAME:Coordinate", _
  "X:=", 350138, "Y:=", 3.54419), Array("NAME:Coordinate", "X:=", 509292, _
  "Y:=", 3.74419), Array("NAME:Coordinate", "X:=", 2.10083e+06, "Y:=", 5.7442))), _
  Array("NAME:core_loss_type", "property_type:=", "ChoiceProperty", _
  "Choice:=", "Electrical Steel"), "core_loss_kh:=", 98.387, "core_loss_kc:=", _
  0.778947, "core_loss_ke:=", 1.33141, "conductivity:=", 1.96e+06, _
  "mass_density:=", 12767.2) 
end if
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.757_N")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.757_N", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.7567", "conductivity:=", "0", _
...
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.757_S")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.757_S", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.7567", "conductivity:=", "0", _
  "mass_density:=", "0", Array("NAME:magnetic_coercivity", "property_type:=", _
  "VectorProperty", "Magnitude:=", "-690015A_per_meter", "DirComp1:=", "-1", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "M19_24G_2DSF1.669", "SolveInside:=", true) 
On Error Resume Next
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/Band", "Version:=", "12.1", "NoOfParameters:=", 7, _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "PartCoordinateSystem:=", "Global", "MaterialName:=", "M19_24G_2DSF1.669", _
  "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Global", "MaterialName:=", "XG196/96_2DSF1.757_N", "SolveInside:=", true) 
On Error Resume Next
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "2301.05rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.000502846, _
  "Load Torque:=", "if(speed<125.937, -0.0346527*speed, -549.595/speed)", _
  "Objects:=", Array("Band"))
