...
if (oDefinitionManager.DoesMaterialExist("M19_24G_2DSF1.625")) then
else
oDefinitionManager.AddMaterial Array("NAME:M19_24G_2DSF1.625", _
  "CoordinateSystemType:=", "Cartesian", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), Array("NAME:permeability", "property_type:=", _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", Array(_
  "NAME:BHCoordinates", Array("NAME:Coordinate", "X:=", 0, "Y:=", 0), Array(_
  "NAME:Coordinate", "X:=", 22.28, "Y:=", 0.0812325), Array("NAME:Coordinate", _
  "X:=", 25.46, "Y:=", 0.16248), Array("NAME:Coordinate", "X:=", 31.83, "Y:=", _
  0.243725), Array("NAME:Coordinate", "X:=", 47.74, "Y:=", 0.584963), Array(_
  "NAME:Coordinate", "X:=", 63.66, "Y:=", 0.87745), Array("NAME:Coordinate", _
  "X:=", 79.57, "Y:=", 1.05619), Array("NAME:Coordinate", "X:=", 159.15, _
  "Y:=", 1.60863), Array("NAME:Coordinate", "X:=", 318.3, "Y:=", 1.94975), _
  Array("NAME:Coordinate", "X:=", 477.46, "Y:=", 2.07963), Array(_
  "NAME:Coordinate", "X:=", 636.61, "Y:=", 2.16075), Array("NAME:Coordinate", _
  "X:=", 795.77, "Y:=", 2.20938), Array("NAME:Coordinate", "X:=", 1591.5, _
  "Y:=", 2.33875), Array("NAME:Coordinate", "X:=", 3183, "Y:=", 2.4675), _
  Array("NAME:Coordinate", "X:=", 4774.6, "Y:=", 2.56375), Array(_
  "NAME:Coordinate", "X:=", 6366.1, "Y:=", 2.64375), Array("NAME:Coordinate", _
  "X:=", 7957.7, "Y:=", 2.7075), Array("NAME:Coordinate", "X:=", 15915, "Y:=", _
  2.9125), Array("NAME:Coordinate", "X:=", 31830, "Y:=", 3.0625), Array(_
  "NAME:Coordinate", "X:=", 111407, "Y:=", 3.1625), Array("NAME:Coordinate", _
  "X:=", 190984, "Y:=", 3.2625), Array("NAME:Coordinate", "X:=", 350138, _
  "Y:=", 3.4625), Array("NAME:Coordinate", "X:=", 509292, "Y:=", 3.6625), _
  Array("NAME:Coordinate", "X:=", 2.10083e+06, "Y:=", 5.66251))), Array(_
  "NAME:core_loss_type", "property_type:=", "ChoiceProperty", "Choice:=", _
  "Electrical Steel"), "core_loss_kh:=", 101.046, "core_loss_kc:=", 0.8, _
  "core_loss_ke:=", 1.34928, "conductivity:=", 1.96e+06, "mass_density:=", _
  12431.3) 
end if
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.711_N")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.711_N", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.71048", "conductivity:=", "0", _
...
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.711_S")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.711_S", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.71048", "conductivity:=", "0", _
  "mass_density:=", "0", Array("NAME:magnetic_coercivity", "property_type:=", _
  "VectorProperty", "Magnitude:=", "-690015A_per_meter", "DirComp1:=", "-1", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "M19_24G_2DSF1.625", "SolveInside:=", true) 
On Error Resume Next
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/Band", "Version:=", "12.1", "NoOfParameters:=", 7, _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "PartCoordinateSystem:=", "Global", "MaterialName:=", "M19_24G_2DSF1.625", _
  "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Global", "MaterialName:=", "XG196/96_2DSF1.711_N", "SolveInside:=", true) 
On Error Resume Next
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "2247.77rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.000520811, _
  "Load Torque:=", "if(speed<123.112, -0.0362583*speed, -549.551/speed)", _
  "Objects:=", Array("Band"))
