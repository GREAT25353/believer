...
if (oDefinitionManager.DoesMaterialExist("M19_24G_2DSF1.583")) then
else
oDefinitionManager.AddMaterial Array("NAME:M19_24G_2DSF1.583", _
  "CoordinateSystemType:=", "Cartesian", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), Array("NAME:permeability", "property_type:=", _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", Array(_
  "NAME:BHCoordinates", Array("NAME:Coordinate", "X:=", 0, "Y:=", 0), Array(_
  "NAME:Coordinate", "X:=", 22.28, "Y:=", 0.0791503), Array("NAME:Coordinate", _
  "X:=", 25.46, "Y:=", 0.158315), Array("NAME:Coordinate", "X:=", 31.83, _
  "Y:=", 0.237477), Array("NAME:Coordinate", "X:=", 47.74, "Y:=", 0.569965), _
  Array("NAME:Coordinate", "X:=", 63.66, "Y:=", 0.854953), Array(_
  "NAME:Coordinate", "X:=", 79.57, "Y:=", 1.02911), Array("NAME:Coordinate", _
  "X:=", 159.15, "Y:=", 1.56738), Array("NAME:Coordinate", "X:=", 318.3, _
  "Y:=", 1.89977), Array("NAME:Coordinate", "X:=", 477.46, "Y:=", 2.02632), _
  Array("NAME:Coordinate", "X:=", 636.61, "Y:=", 2.10537), Array(_
  "NAME:Coordinate", "X:=", 795.77, "Y:=", 2.15275), Array("NAME:Coordinate", _
  "X:=", 1591.5, "Y:=", 2.27883), Array("NAME:Coordinate", "X:=", 3183, "Y:=", _
  2.40433), Array("NAME:Coordinate", "X:=", 4774.6, "Y:=", 2.49817), Array(_
  "NAME:Coordinate", "X:=", 6366.1, "Y:=", 2.57617), Array("NAME:Coordinate", _
  "X:=", 7957.7, "Y:=", 2.63833), Array("NAME:Coordinate", "X:=", 15915, _
  "Y:=", 2.83833), Array("NAME:Coordinate", "X:=", 31830, "Y:=", 2.985), _
  Array("NAME:Coordinate", "X:=", 111407, "Y:=", 3.085), Array(_
  "NAME:Coordinate", "X:=", 190984, "Y:=", 3.185), Array("NAME:Coordinate", _
  "X:=", 350138, "Y:=", 3.385), Array("NAME:Coordinate", "X:=", 509292, "Y:=", _
  3.585), Array("NAME:Coordinate", "X:=", 2.10083e+06, "Y:=", 5.58501))), _
  Array("NAME:core_loss_type", "property_type:=", "ChoiceProperty", _
  "Choice:=", "Electrical Steel"), "core_loss_kh:=", 103.705, _
  "core_loss_kc:=", 0.821053, "core_loss_ke:=", 1.36692, "conductivity:=", _
  1.96e+06, "mass_density:=", 12112.5) 
end if
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.667_N")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.667_N", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.66662", "conductivity:=", "0", _
...
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.667_S")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.667_S", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.66662", "conductivity:=", "0", _
  "mass_density:=", "0", Array("NAME:magnetic_coercivity", "property_type:=", _
  "VectorProperty", "Magnitude:=", "-690015A_per_meter", "DirComp1:=", "-1", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "M19_24G_2DSF1.583", "SolveInside:=", true) 
On Error Resume Next
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/Band", "Version:=", "12.1", "NoOfParameters:=", 7, _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "PartCoordinateSystem:=", "Global", "MaterialName:=", "M19_24G_2DSF1.583", _
  "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Global", "MaterialName:=", "XG196/96_2DSF1.667_N", "SolveInside:=", true) 
On Error Resume Next
