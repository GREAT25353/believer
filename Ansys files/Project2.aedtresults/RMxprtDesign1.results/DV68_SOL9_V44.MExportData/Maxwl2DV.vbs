...
if (oDefinitionManager.DoesMaterialExist("M19_24G_2DSF1.544")) then
else
oDefinitionManager.AddMaterial Array("NAME:M19_24G_2DSF1.544", _
  "CoordinateSystemType:=", "Cartesian", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), Array("NAME:permeability", "property_type:=", _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", Array(_
  "NAME:BHCoordinates", Array("NAME:Coordinate", "X:=", 0, "Y:=", 0), Array(_
  "NAME:Coordinate", "X:=", 22.28, "Y:=", 0.0771723), Array("NAME:Coordinate", _
  "X:=", 25.46, "Y:=", 0.154358), Array("NAME:Coordinate", "X:=", 31.83, _
  "Y:=", 0.231541), Array("NAME:Coordinate", "X:=", 47.74, "Y:=", 0.555717), _
  Array("NAME:Coordinate", "X:=", 63.66, "Y:=", 0.833582), Array(_
  "NAME:Coordinate", "X:=", 79.57, "Y:=", 1.00338), Array("NAME:Coordinate", _
  "X:=", 159.15, "Y:=", 1.5282), Array("NAME:Coordinate", "X:=", 318.3, "Y:=", _
  1.85228), Array("NAME:Coordinate", "X:=", 477.46, "Y:=", 1.97567), Array(_
  "NAME:Coordinate", "X:=", 636.61, "Y:=", 2.05275), Array("NAME:Coordinate", _
  "X:=", 795.77, "Y:=", 2.09896), Array("NAME:Coordinate", "X:=", 1591.5, _
  "Y:=", 2.22191), Array("NAME:Coordinate", "X:=", 3183, "Y:=", 2.34433), _
  Array("NAME:Coordinate", "X:=", 4774.6, "Y:=", 2.43586), Array(_
  "NAME:Coordinate", "X:=", 6366.1, "Y:=", 2.51196), Array("NAME:Coordinate", _
  "X:=", 7957.7, "Y:=", 2.57263), Array("NAME:Coordinate", "X:=", 15915, _
  "Y:=", 2.76788), Array("NAME:Coordinate", "X:=", 31830, "Y:=", 2.91138), _
  Array("NAME:Coordinate", "X:=", 111407, "Y:=", 3.01138), Array(_
  "NAME:Coordinate", "X:=", 190984, "Y:=", 3.11138), Array("NAME:Coordinate", _
  "X:=", 350138, "Y:=", 3.31138), Array("NAME:Coordinate", "X:=", 509292, _
  "Y:=", 3.51138), Array("NAME:Coordinate", "X:=", 2.10083e+06, "Y:=", _
  5.51138))), Array("NAME:core_loss_type", "property_type:=", _
  "ChoiceProperty", "Choice:=", "Electrical Steel"), "core_loss_kh:=", _
  106.364, "core_loss_kc:=", 0.842105, "core_loss_ke:=", 1.38433, _
  "conductivity:=", 1.96e+06, "mass_density:=", 11809.7) 
end if
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.625_N")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.625_N", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.62495", "conductivity:=", "0", _
...
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.625_S")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.625_S", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.62495", "conductivity:=", "0", _
  "mass_density:=", "0", Array("NAME:magnetic_coercivity", "property_type:=", _
  "VectorProperty", "Magnitude:=", "-690015A_per_meter", "DirComp1:=", "-1", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "M19_24G_2DSF1.544", "SolveInside:=", true) 
On Error Resume Next
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/Band", "Version:=", "12.1", "NoOfParameters:=", 7, _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "PartCoordinateSystem:=", "Global", "MaterialName:=", "M19_24G_2DSF1.544", _
  "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Global", "MaterialName:=", "XG196/96_2DSF1.625_N", "SolveInside:=", true) 
On Error Resume Next
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "2151.16rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.000555305, _
  "Load Torque:=", "if(speed<118.009, -0.0394951*speed, -550.011/speed)", _
  "Objects:=", Array("Band"))
