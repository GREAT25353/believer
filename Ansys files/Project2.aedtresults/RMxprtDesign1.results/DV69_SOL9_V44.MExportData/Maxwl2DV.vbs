...
if (oDefinitionManager.DoesMaterialExist("M19_24G_2DSF1.506")) then
else
oDefinitionManager.AddMaterial Array("NAME:M19_24G_2DSF1.506", _
  "CoordinateSystemType:=", "Cartesian", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), Array("NAME:permeability", "property_type:=", _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", Array(_
  "NAME:BHCoordinates", Array("NAME:Coordinate", "X:=", 0, "Y:=", 0), Array(_
  "NAME:Coordinate", "X:=", 22.28, "Y:=", 0.0752907), Array("NAME:Coordinate", _
  "X:=", 25.46, "Y:=", 0.150594), Array("NAME:Coordinate", "X:=", 31.83, _
  "Y:=", 0.225894), Array("NAME:Coordinate", "X:=", 47.74, "Y:=", 0.542165), _
  Array("NAME:Coordinate", "X:=", 63.66, "Y:=", 0.813252), Array(_
  "NAME:Coordinate", "X:=", 79.57, "Y:=", 0.978913), Array("NAME:Coordinate", _
  "X:=", 159.15, "Y:=", 1.49094), Array("NAME:Coordinate", "X:=", 318.3, _
  "Y:=", 1.80711), Array("NAME:Coordinate", "X:=", 477.46, "Y:=", 1.9275), _
  Array("NAME:Coordinate", "X:=", 636.61, "Y:=", 2.0027), Array(_
  "NAME:Coordinate", "X:=", 795.77, "Y:=", 2.04779), Array("NAME:Coordinate", _
  "X:=", 1591.5, "Y:=", 2.16777), Array("NAME:Coordinate", "X:=", 3183, "Y:=", _
  2.28724), Array("NAME:Coordinate", "X:=", 4774.6, "Y:=", 2.3766), Array(_
  "NAME:Coordinate", "X:=", 6366.1, "Y:=", 2.45089), Array("NAME:Coordinate", _
  "X:=", 7957.7, "Y:=", 2.51012), Array("NAME:Coordinate", "X:=", 15915, _
  "Y:=", 2.70085), Array("NAME:Coordinate", "X:=", 31830, "Y:=", 2.84134), _
  Array("NAME:Coordinate", "X:=", 111407, "Y:=", 2.94134), Array(_
  "NAME:Coordinate", "X:=", 190984, "Y:=", 3.04134), Array("NAME:Coordinate", _
  "X:=", 350138, "Y:=", 3.24134), Array("NAME:Coordinate", "X:=", 509292, _
  "Y:=", 3.44134), Array("NAME:Coordinate", "X:=", 2.10083e+06, "Y:=", _
  5.44135))), Array("NAME:core_loss_type", "property_type:=", _
  "ChoiceProperty", "Choice:=", "Electrical Steel"), "core_loss_kh:=", _
  109.023, "core_loss_kc:=", 0.863158, "core_loss_ke:=", 1.40153, _
  "conductivity:=", 1.96e+06, "mass_density:=", 11521.6) 
end if
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.585_N")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.585_N", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.58532", "conductivity:=", "0", _
...
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.585_S")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.585_S", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.58532", "conductivity:=", "0", _
  "mass_density:=", "0", Array("NAME:magnetic_coercivity", "property_type:=", _
  "VectorProperty", "Magnitude:=", "-690015A_per_meter", "DirComp1:=", "-1", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "M19_24G_2DSF1.506", "SolveInside:=", true) 
On Error Resume Next
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/Band", "Version:=", "12.1", "NoOfParameters:=", 7, _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "PartCoordinateSystem:=", "Global", "MaterialName:=", "M19_24G_2DSF1.506", _
  "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Global", "MaterialName:=", "XG196/96_2DSF1.585_N", "SolveInside:=", true) 
On Error Resume Next
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "2110.79rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.000569169, _
  "Load Torque:=", "if(speed<115.898, -0.0409113*speed, -549.537/speed)", _
  "Objects:=", Array("Band"))
