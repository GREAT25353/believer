...
if (oDefinitionManager.DoesMaterialExist("M19_24G_2DSF1.470")) then
else
oDefinitionManager.AddMaterial Array("NAME:M19_24G_2DSF1.470", _
  "CoordinateSystemType:=", "Cartesian", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), Array("NAME:permeability", "property_type:=", _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", Array(_
  "NAME:BHCoordinates", Array("NAME:Coordinate", "X:=", 0, "Y:=", 0), Array(_
  "NAME:Coordinate", "X:=", 22.28, "Y:=", 0.0734987), Array("NAME:Coordinate", _
  "X:=", 25.46, "Y:=", 0.147009), Array("NAME:Coordinate", "X:=", 31.83, _
  "Y:=", 0.220517), Array("NAME:Coordinate", "X:=", 47.74, "Y:=", 0.529258), _
  Array("NAME:Coordinate", "X:=", 63.66, "Y:=", 0.793891), Array(_
  "NAME:Coordinate", "X:=", 79.57, "Y:=", 0.955608), Array("NAME:Coordinate", _
  "X:=", 159.15, "Y:=", 1.45544), Array("NAME:Coordinate", "X:=", 318.3, _
  "Y:=", 1.7641), Array("NAME:Coordinate", "X:=", 477.46, "Y:=", 1.88162), _
  Array("NAME:Coordinate", "X:=", 636.61, "Y:=", 1.95504), Array(_
  "NAME:Coordinate", "X:=", 795.77, "Y:=", 1.99905), Array("NAME:Coordinate", _
  "X:=", 1591.5, "Y:=", 2.1162), Array("NAME:Coordinate", "X:=", 3183, "Y:=", _
  2.23288), Array("NAME:Coordinate", "X:=", 4774.6, "Y:=", 2.32015), Array(_
  "NAME:Coordinate", "X:=", 6366.1, "Y:=", 2.39273), Array("NAME:Coordinate", _
  "X:=", 7957.7, "Y:=", 2.4506), Array("NAME:Coordinate", "X:=", 15915, "Y:=", _
  2.63702), Array("NAME:Coordinate", "X:=", 31830, "Y:=", 2.77464), Array(_
  "NAME:Coordinate", "X:=", 111407, "Y:=", 2.87464), Array("NAME:Coordinate", _
  "X:=", 190984, "Y:=", 2.97464), Array("NAME:Coordinate", "X:=", 350138, _
  "Y:=", 3.17464), Array("NAME:Coordinate", "X:=", 509292, "Y:=", 3.37465), _
  Array("NAME:Coordinate", "X:=", 2.10083e+06, "Y:=", 5.37465))), Array(_
  "NAME:core_loss_type", "property_type:=", "ChoiceProperty", "Choice:=", _
  "Electrical Steel"), "core_loss_kh:=", 111.683, "core_loss_kc:=", 0.884211, _
  "core_loss_ke:=", 1.41852, "conductivity:=", 1.96e+06, "mass_density:=", _
  11247.3) 
end if
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.548_N")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.548_N", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.54757", "conductivity:=", "0", _
...
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.548_S")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.548_S", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.54757", "conductivity:=", "0", _
  "mass_density:=", "0", Array("NAME:magnetic_coercivity", "property_type:=", _
  "VectorProperty", "Magnitude:=", "-690015A_per_meter", "DirComp1:=", "-1", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "M19_24G_2DSF1.470", "SolveInside:=", true) 
On Error Resume Next
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/Band", "Version:=", "12.1", "NoOfParameters:=", 7, _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "PartCoordinateSystem:=", "Global", "MaterialName:=", "M19_24G_2DSF1.470", _
  "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Global", "MaterialName:=", "XG196/96_2DSF1.548_N", "SolveInside:=", true) 
On Error Resume Next
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "2072.1rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.000582951, _
  "Load Torque:=", "if(speed<113.883, -0.0423955*speed, -549.846/speed)", _
  "Objects:=", Array("Band"))
