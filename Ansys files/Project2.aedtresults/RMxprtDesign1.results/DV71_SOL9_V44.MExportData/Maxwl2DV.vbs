...
if (oDefinitionManager.DoesMaterialExist("M19_24G_2DSF1.436")) then
else
oDefinitionManager.AddMaterial Array("NAME:M19_24G_2DSF1.436", _
  "CoordinateSystemType:=", "Cartesian", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), Array("NAME:permeability", "property_type:=", _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", Array(_
  "NAME:BHCoordinates", Array("NAME:Coordinate", "X:=", 0, "Y:=", 0), Array(_
  "NAME:Coordinate", "X:=", 22.28, "Y:=", 0.0717901), Array("NAME:Coordinate", _
  "X:=", 25.46, "Y:=", 0.143591), Array("NAME:Coordinate", "X:=", 31.83, _
  "Y:=", 0.21539), Array("NAME:Coordinate", "X:=", 47.74, "Y:=", 0.516951), _
  Array("NAME:Coordinate", "X:=", 63.66, "Y:=", 0.77543), Array(_
  "NAME:Coordinate", "X:=", 79.57, "Y:=", 0.933387), Array("NAME:Coordinate", _
  "X:=", 159.15, "Y:=", 1.4216), Array("NAME:Coordinate", "X:=", 318.3, "Y:=", _
  1.72308), Array("NAME:Coordinate", "X:=", 477.46, "Y:=", 1.83788), Array(_
  "NAME:Coordinate", "X:=", 636.61, "Y:=", 1.90959), Array("NAME:Coordinate", _
  "X:=", 795.77, "Y:=", 1.95259), Array("NAME:Coordinate", "X:=", 1591.5, _
  "Y:=", 2.06703), Array("NAME:Coordinate", "X:=", 3183, "Y:=", 2.18105), _
  Array("NAME:Coordinate", "X:=", 4774.6, "Y:=", 2.26634), Array(_
  "NAME:Coordinate", "X:=", 6366.1, "Y:=", 2.33727), Array("NAME:Coordinate", _
  "X:=", 7957.7, "Y:=", 2.39384), Array("NAME:Coordinate", "X:=", 15915, _
  "Y:=", 2.57616), Array("NAME:Coordinate", "X:=", 31830, "Y:=", 2.71105), _
  Array("NAME:Coordinate", "X:=", 111407, "Y:=", 2.81105), Array(_
  "NAME:Coordinate", "X:=", 190984, "Y:=", 2.91105), Array("NAME:Coordinate", _
  "X:=", 350138, "Y:=", 3.11105), Array("NAME:Coordinate", "X:=", 509292, _
  "Y:=", 3.31105), Array("NAME:Coordinate", "X:=", 2.10083e+06, "Y:=", _
  5.31105))), Array("NAME:core_loss_type", "property_type:=", _
  "ChoiceProperty", "Choice:=", "Electrical Steel"), "core_loss_kh:=", _
  114.342, "core_loss_kc:=", 0.905263, "core_loss_ke:=", 1.4353, _
  "conductivity:=", 1.96e+06, "mass_density:=", 10985.8) 
end if
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.512_N")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.512_N", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.51158", "conductivity:=", "0", _
...
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.512_S")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.512_S", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.51158", "conductivity:=", "0", _
  "mass_density:=", "0", Array("NAME:magnetic_coercivity", "property_type:=", _
  "VectorProperty", "Magnitude:=", "-690015A_per_meter", "DirComp1:=", "-1", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "M19_24G_2DSF1.436", "SolveInside:=", true) 
On Error Resume Next
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/Band", "Version:=", "12.1", "NoOfParameters:=", 7, _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "PartCoordinateSystem:=", "Global", "MaterialName:=", "M19_24G_2DSF1.436", _
  "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Global", "MaterialName:=", "XG196/96_2DSF1.512_N", "SolveInside:=", true) 
On Error Resume Next
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "2035.11rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.000596624, _
  "Load Torque:=", "if(speed<111.958, -0.0438884*speed, -550.123/speed)", _
  "Objects:=", Array("Band"))
