...
if (oDefinitionManager.DoesMaterialExist("M19_24G_2DSF1.403")) then
else
oDefinitionManager.AddMaterial Array("NAME:M19_24G_2DSF1.403", _
  "CoordinateSystemType:=", "Cartesian", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), Array("NAME:permeability", "property_type:=", _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", Array(_
  "NAME:BHCoordinates", Array("NAME:Coordinate", "X:=", 0, "Y:=", 0), Array(_
  "NAME:Coordinate", "X:=", 22.28, "Y:=", 0.0701592), Array("NAME:Coordinate", _
  "X:=", 25.46, "Y:=", 0.140328), Array("NAME:Coordinate", "X:=", 31.83, _
  "Y:=", 0.210495), Array("NAME:Coordinate", "X:=", 47.74, "Y:=", 0.505203), _
  Array("NAME:Coordinate", "X:=", 63.66, "Y:=", 0.757809), Array(_
  "NAME:Coordinate", "X:=", 79.57, "Y:=", 0.912176), Array("NAME:Coordinate", _
  "X:=", 159.15, "Y:=", 1.38929), Array("NAME:Coordinate", "X:=", 318.3, _
  "Y:=", 1.68393), Array("NAME:Coordinate", "X:=", 477.46, "Y:=", 1.79612), _
  Array("NAME:Coordinate", "X:=", 636.61, "Y:=", 1.86621), Array(_
  "NAME:Coordinate", "X:=", 795.77, "Y:=", 1.90823), Array("NAME:Coordinate", _
  "X:=", 1591.5, "Y:=", 2.0201), Array("NAME:Coordinate", "X:=", 3183, "Y:=", _
  2.13157), Array("NAME:Coordinate", "X:=", 4774.6, "Y:=", 2.21497), Array(_
  "NAME:Coordinate", "X:=", 6366.1, "Y:=", 2.28433), Array("NAME:Coordinate", _
  "X:=", 7957.7, "Y:=", 2.33966), Array("NAME:Coordinate", "X:=", 15915, _
  "Y:=", 2.51807), Array("NAME:Coordinate", "X:=", 31830, "Y:=", 2.65034), _
  Array("NAME:Coordinate", "X:=", 111407, "Y:=", 2.75034), Array(_
  "NAME:Coordinate", "X:=", 190984, "Y:=", 2.85034), Array("NAME:Coordinate", _
  "X:=", 350138, "Y:=", 3.05034), Array("NAME:Coordinate", "X:=", 509292, _
  "Y:=", 3.25034), Array("NAME:Coordinate", "X:=", 2.10083e+06, "Y:=", _
  5.25035))), Array("NAME:core_loss_type", "property_type:=", _
  "ChoiceProperty", "Choice:=", "Electrical Steel"), "core_loss_kh:=", _
  117.001, "core_loss_kc:=", 0.926316, "core_loss_ke:=", 1.4519, _
  "conductivity:=", 1.96e+06, "mass_density:=", 10736.1) 
end if
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.477_N")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.477_N", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.47723", "conductivity:=", "0", _
...
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.477_S")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.477_S", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.47723", "conductivity:=", "0", _
  "mass_density:=", "0", Array("NAME:magnetic_coercivity", "property_type:=", _
  "VectorProperty", "Magnitude:=", "-690015A_per_meter", "DirComp1:=", "-1", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "M19_24G_2DSF1.403", "SolveInside:=", true) 
On Error Resume Next
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/Band", "Version:=", "12.1", "NoOfParameters:=", 7, _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "PartCoordinateSystem:=", "Global", "MaterialName:=", "M19_24G_2DSF1.403", _
  "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Global", "MaterialName:=", "XG196/96_2DSF1.477_N", "SolveInside:=", true) 
On Error Resume Next
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "1999.66rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.000610189, _
  "Load Torque:=", "if(speed<105.111, -0.0497958*speed, -550.162/speed)", _
  "Objects:=", Array("Band"))
