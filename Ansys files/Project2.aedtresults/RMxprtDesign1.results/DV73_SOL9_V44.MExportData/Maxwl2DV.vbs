...
if (oDefinitionManager.DoesMaterialExist("M19_24G_2DSF1.372")) then
else
oDefinitionManager.AddMaterial Array("NAME:M19_24G_2DSF1.372", _
  "CoordinateSystemType:=", "Cartesian", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), Array("NAME:permeability", "property_type:=", _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", Array(_
  "NAME:BHCoordinates", Array("NAME:Coordinate", "X:=", 0, "Y:=", 0), Array(_
  "NAME:Coordinate", "X:=", 22.28, "Y:=", 0.0686007), Array("NAME:Coordinate", _
  "X:=", 25.46, "Y:=", 0.13721), Array("NAME:Coordinate", "X:=", 31.83, "Y:=", _
  0.205818), Array("NAME:Coordinate", "X:=", 47.74, "Y:=", 0.493978), Array(_
  "NAME:Coordinate", "X:=", 63.66, "Y:=", 0.74097), Array("NAME:Coordinate", _
  "X:=", 79.57, "Y:=", 0.891907), Array("NAME:Coordinate", "X:=", 159.15, _
  "Y:=", 1.35843), Array("NAME:Coordinate", "X:=", 318.3, "Y:=", 1.64652), _
  Array("NAME:Coordinate", "X:=", 477.46, "Y:=", 1.75622), Array(_
  "NAME:Coordinate", "X:=", 636.61, "Y:=", 1.82476), Array("NAME:Coordinate", _
  "X:=", 795.77, "Y:=", 1.86585), Array("NAME:Coordinate", "X:=", 1591.5, _
  "Y:=", 1.97526), Array("NAME:Coordinate", "X:=", 3183, "Y:=", 2.08429), _
  Array("NAME:Coordinate", "X:=", 4774.6, "Y:=", 2.16588), Array(_
  "NAME:Coordinate", "X:=", 6366.1, "Y:=", 2.23374), Array("NAME:Coordinate", _
  "X:=", 7957.7, "Y:=", 2.28789), Array("NAME:Coordinate", "X:=", 15915, _
  "Y:=", 2.46256), Array("NAME:Coordinate", "X:=", 31830, "Y:=", 2.59233), _
  Array("NAME:Coordinate", "X:=", 111407, "Y:=", 2.69233), Array(_
  "NAME:Coordinate", "X:=", 190984, "Y:=", 2.79233), Array("NAME:Coordinate", _
  "X:=", 350138, "Y:=", 2.99233), Array("NAME:Coordinate", "X:=", 509292, _
  "Y:=", 3.19234), Array("NAME:Coordinate", "X:=", 2.10083e+06, "Y:=", _
  5.19234))), Array("NAME:core_loss_type", "property_type:=", _
  "ChoiceProperty", "Choice:=", "Electrical Steel"), "core_loss_kh:=", 119.66, _
  "core_loss_kc:=", 0.947368, "core_loss_ke:=", 1.4683, "conductivity:=", _
  1.96e+06, "mass_density:=", 10497.5) 
end if
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.444_N")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.444_N", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.4444", "conductivity:=", "0", _
  "mass_density:=", "0", Array("NAME:magnetic_coercivity", "property_type:=", _
  "VectorProperty", "Magnitude:=", "-690015A_per_meter", "DirComp1:=", "1", _
  "DirComp2:=", "0", "DirComp3:=", "0"))
end if
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.444_S")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.444_S", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.4444", "conductivity:=", "0", _
  "mass_density:=", "0", Array("NAME:magnetic_coercivity", "property_type:=", _
  "VectorProperty", "Magnitude:=", "-690015A_per_meter", "DirComp1:=", "-1", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "M19_24G_2DSF1.372", "SolveInside:=", true) 
On Error Resume Next
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/Band", "Version:=", "12.1", "NoOfParameters:=", 7, _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "PartCoordinateSystem:=", "Global", "MaterialName:=", "M19_24G_2DSF1.372", _
  "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Global", "MaterialName:=", "XG196/96_2DSF1.444_N", "SolveInside:=", true) 
On Error Resume Next
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "1966.11rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.000623317, _
  "Load Torque:=", "if(speed<103.447, -0.0514142*speed, -550.198/speed)", _
  "Objects:=", Array("Band"))
