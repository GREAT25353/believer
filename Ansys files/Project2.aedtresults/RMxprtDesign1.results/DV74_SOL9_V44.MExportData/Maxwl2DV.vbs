...
if (oDefinitionManager.DoesMaterialExist("M19_24G_2DSF1.342")) then
else
oDefinitionManager.AddMaterial Array("NAME:M19_24G_2DSF1.342", _
  "CoordinateSystemType:=", "Cartesian", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), Array("NAME:permeability", "property_type:=", _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", Array(_
  "NAME:BHCoordinates", Array("NAME:Coordinate", "X:=", 0, "Y:=", 0), Array(_
  "NAME:Coordinate", "X:=", 22.28, "Y:=", 0.06711), Array("NAME:Coordinate", _
  "X:=", 25.46, "Y:=", 0.134228), Array("NAME:Coordinate", "X:=", 31.83, _
  "Y:=", 0.201345), Array("NAME:Coordinate", "X:=", 47.74, "Y:=", 0.48324), _
  Array("NAME:Coordinate", "X:=", 63.66, "Y:=", 0.724864), Array(_
  "NAME:Coordinate", "X:=", 79.57, "Y:=", 0.87252), Array("NAME:Coordinate", _
  "X:=", 159.15, "Y:=", 1.3289), Array("NAME:Coordinate", "X:=", 318.3, "Y:=", _
  1.61073), Array("NAME:Coordinate", "X:=", 477.46, "Y:=", 1.71806), Array(_
  "NAME:Coordinate", "X:=", 636.61, "Y:=", 1.78511), Array("NAME:Coordinate", _
  "X:=", 795.77, "Y:=", 1.82531), Array("NAME:Coordinate", "X:=", 1591.5, _
  "Y:=", 1.93236), Array("NAME:Coordinate", "X:=", 3183, "Y:=", 2.03907), _
  Array("NAME:Coordinate", "X:=", 4774.6, "Y:=", 2.11892), Array(_
  "NAME:Coordinate", "X:=", 6366.1, "Y:=", 2.18536), Array("NAME:Coordinate", _
  "X:=", 7957.7, "Y:=", 2.23837), Array("NAME:Coordinate", "X:=", 15915, _
  "Y:=", 2.40946), Array("NAME:Coordinate", "X:=", 31830, "Y:=", 2.53685), _
  Array("NAME:Coordinate", "X:=", 111407, "Y:=", 2.63685), Array(_
  "NAME:Coordinate", "X:=", 190984, "Y:=", 2.73685), Array("NAME:Coordinate", _
  "X:=", 350138, "Y:=", 2.93685), Array("NAME:Coordinate", "X:=", 509292, _
  "Y:=", 3.13685), Array("NAME:Coordinate", "X:=", 2.10083e+06, "Y:=", _
  5.13685))), Array("NAME:core_loss_type", "property_type:=", _
  "ChoiceProperty", "Choice:=", "Electrical Steel"), "core_loss_kh:=", _
  122.319, "core_loss_kc:=", 0.968421, "core_loss_ke:=", 1.48453, _
  "conductivity:=", 1.96e+06, "mass_density:=", 10269.3) 
end if
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.413_N")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.413_N", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.413", "conductivity:=", "0", _
...
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.413_S")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.413_S", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.413", "conductivity:=", "0", _
  "mass_density:=", "0", Array("NAME:magnetic_coercivity", "property_type:=", _
  "VectorProperty", "Magnitude:=", "-690015A_per_meter", "DirComp1:=", "-1", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "M19_24G_2DSF1.342", "SolveInside:=", true) 
On Error Resume Next
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/Band", "Version:=", "12.1", "NoOfParameters:=", 7, _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "PartCoordinateSystem:=", "Global", "MaterialName:=", "M19_24G_2DSF1.342", _
  "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Global", "MaterialName:=", "XG196/96_2DSF1.413_N", "SolveInside:=", true) 
On Error Resume Next
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "1933.63rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.000636608, _
  "Load Torque:=", "if(speed<101.835, -0.0530582*speed, -550.231/speed)", _
  "Objects:=", Array("Band"))
