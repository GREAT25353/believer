...
if (oDefinitionManager.DoesMaterialExist("M19_24G_2DSF1.314")) then
else
oDefinitionManager.AddMaterial Array("NAME:M19_24G_2DSF1.314", _
  "CoordinateSystemType:=", "Cartesian", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), Array("NAME:permeability", "property_type:=", _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", Array(_
  "NAME:BHCoordinates", Array("NAME:Coordinate", "X:=", 0, "Y:=", 0), Array(_
  "NAME:Coordinate", "X:=", 22.28, "Y:=", 0.0656827), Array("NAME:Coordinate", _
  "X:=", 25.46, "Y:=", 0.131373), Array("NAME:Coordinate", "X:=", 31.83, _
  "Y:=", 0.197062), Array("NAME:Coordinate", "X:=", 47.74, "Y:=", 0.47296), _
  Array("NAME:Coordinate", "X:=", 63.66, "Y:=", 0.709443), Array(_
  "NAME:Coordinate", "X:=", 79.57, "Y:=", 0.853958), Array("NAME:Coordinate", _
  "X:=", 159.15, "Y:=", 1.30063), Array("NAME:Coordinate", "X:=", 318.3, _
  "Y:=", 1.57647), Array("NAME:Coordinate", "X:=", 477.46, "Y:=", 1.68151), _
  Array("NAME:Coordinate", "X:=", 636.61, "Y:=", 1.74714), Array(_
  "NAME:Coordinate", "X:=", 795.77, "Y:=", 1.78649), Array("NAME:Coordinate", _
  "X:=", 1591.5, "Y:=", 1.89129), Array("NAME:Coordinate", "X:=", 3183, "Y:=", _
  1.99577), Array("NAME:Coordinate", "X:=", 4774.6, "Y:=", 2.07397), Array(_
  "NAME:Coordinate", "X:=", 6366.1, "Y:=", 2.13903), Array("NAME:Coordinate", _
  "X:=", 7957.7, "Y:=", 2.19096), Array("NAME:Coordinate", "X:=", 15915, _
  "Y:=", 2.35862), Array("NAME:Coordinate", "X:=", 31830, "Y:=", 2.48372), _
  Array("NAME:Coordinate", "X:=", 111407, "Y:=", 2.58372), Array(_
  "NAME:Coordinate", "X:=", 190984, "Y:=", 2.68372), Array("NAME:Coordinate", _
  "X:=", 350138, "Y:=", 2.88372), Array("NAME:Coordinate", "X:=", 509292, _
  "Y:=", 3.08372), Array("NAME:Coordinate", "X:=", 2.10083e+06, "Y:=", _
  5.08373))), Array("NAME:core_loss_type", "property_type:=", _
  "ChoiceProperty", "Choice:=", "Electrical Steel"), "core_loss_kh:=", _
  124.978, "core_loss_kc:=", 0.989474, "core_loss_ke:=", 1.50058, _
  "conductivity:=", 1.96e+06, "mass_density:=", 10050.8) 
end if
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.383_N")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.383_N", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.38294", "conductivity:=", "0", _
...
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.383_S")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.383_S", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.38294", "conductivity:=", "0", _
  "mass_density:=", "0", Array("NAME:magnetic_coercivity", "property_type:=", _
  "VectorProperty", "Magnitude:=", "-690015A_per_meter", "DirComp1:=", "-1", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "M19_24G_2DSF1.314", "SolveInside:=", true) 
On Error Resume Next
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/Band", "Version:=", "12.1", "NoOfParameters:=", 7, _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "PartCoordinateSystem:=", "Global", "MaterialName:=", "M19_24G_2DSF1.314", _
  "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Global", "MaterialName:=", "XG196/96_2DSF1.383_N", "SolveInside:=", true) 
On Error Resume Next
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "1902.65rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.000649495, _
  "Load Torque:=", "if(speed<100.307, -0.0546905*speed, -550.264/speed)", _
  "Objects:=", Array("Band"))
