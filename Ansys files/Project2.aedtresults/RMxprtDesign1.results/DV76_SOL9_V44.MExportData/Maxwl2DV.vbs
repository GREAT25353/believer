...
if (oDefinitionManager.DoesMaterialExist("M19_24G_2DSF1.286")) then
else
oDefinitionManager.AddMaterial Array("NAME:M19_24G_2DSF1.286", _
  "CoordinateSystemType:=", "Cartesian", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), Array("NAME:permeability", "property_type:=", _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", Array(_
  "NAME:BHCoordinates", Array("NAME:Coordinate", "X:=", 0, "Y:=", 0), Array(_
  "NAME:Coordinate", "X:=", 22.28, "Y:=", 0.0643149), Array("NAME:Coordinate", _
  "X:=", 25.46, "Y:=", 0.128637), Array("NAME:Coordinate", "X:=", 31.83, _
  "Y:=", 0.192957), Array("NAME:Coordinate", "X:=", 47.74, "Y:=", 0.463108), _
  Array("NAME:Coordinate", "X:=", 63.66, "Y:=", 0.694665), Array(_
  "NAME:Coordinate", "X:=", 79.57, "Y:=", 0.836169), Array("NAME:Coordinate", _
  "X:=", 159.15, "Y:=", 1.27354), Array("NAME:Coordinate", "X:=", 318.3, _
  "Y:=", 1.54364), Array("NAME:Coordinate", "X:=", 477.46, "Y:=", 1.64649), _
  Array("NAME:Coordinate", "X:=", 636.61, "Y:=", 1.71076), Array(_
  "NAME:Coordinate", "X:=", 795.77, "Y:=", 1.7493), Array("NAME:Coordinate", _
  "X:=", 1591.5, "Y:=", 1.85193), Array("NAME:Coordinate", "X:=", 3183, "Y:=", _
  1.95427), Array("NAME:Coordinate", "X:=", 4774.6, "Y:=", 2.03089), Array(_
  "NAME:Coordinate", "X:=", 6366.1, "Y:=", 2.09464), Array("NAME:Coordinate", _
  "X:=", 7957.7, "Y:=", 2.14552), Array("NAME:Coordinate", "X:=", 15915, _
  "Y:=", 2.3099), Array("NAME:Coordinate", "X:=", 31830, "Y:=", 2.43281), _
  Array("NAME:Coordinate", "X:=", 111407, "Y:=", 2.53281), Array(_
  "NAME:Coordinate", "X:=", 190984, "Y:=", 2.63281), Array("NAME:Coordinate", _
  "X:=", 350138, "Y:=", 2.83281), Array("NAME:Coordinate", "X:=", 509292, _
  "Y:=", 3.03281), Array("NAME:Coordinate", "X:=", 2.10083e+06, "Y:=", _
  5.03282))), Array("NAME:core_loss_type", "property_type:=", _
  "ChoiceProperty", "Choice:=", "Electrical Steel"), "core_loss_kh:=", _
  127.637, "core_loss_kc:=", 1.01053, "core_loss_ke:=", 1.51646, _
  "conductivity:=", 1.96e+06, "mass_density:=", 9841.41) 
end if
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.354_N")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.354_N", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.35413", "conductivity:=", "0", _
...
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.354_S")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.354_S", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.35413", "conductivity:=", "0", _
  "mass_density:=", "0", Array("NAME:magnetic_coercivity", "property_type:=", _
  "VectorProperty", "Magnitude:=", "-690015A_per_meter", "DirComp1:=", "-1", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "M19_24G_2DSF1.286", "SolveInside:=", true) 
On Error Resume Next
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/Band", "Version:=", "12.1", "NoOfParameters:=", 7, _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "PartCoordinateSystem:=", "Global", "MaterialName:=", "M19_24G_2DSF1.286", _
  "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Global", "MaterialName:=", "XG196/96_2DSF1.354_N", "SolveInside:=", true) 
On Error Resume Next
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "1872.99rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.000662215, _
  "Load Torque:=", "if(speed<98.8404, -0.056328*speed, -550.293/speed)", _
  "Objects:=", Array("Band"))
