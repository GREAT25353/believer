...
if (oDefinitionManager.DoesMaterialExist("M19_24G_2DSF1.260")) then
else
oDefinitionManager.AddMaterial Array("NAME:M19_24G_2DSF1.260", _
  "CoordinateSystemType:=", "Cartesian", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), Array("NAME:permeability", "property_type:=", _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", Array(_
  "NAME:BHCoordinates", Array("NAME:Coordinate", "X:=", 0, "Y:=", 0), Array(_
  "NAME:Coordinate", "X:=", 22.28, "Y:=", 0.0630029), Array("NAME:Coordinate", _
  "X:=", 25.46, "Y:=", 0.126012), Array("NAME:Coordinate", "X:=", 31.83, _
  "Y:=", 0.18902), Array("NAME:Coordinate", "X:=", 47.74, "Y:=", 0.453658), _
  Array("NAME:Coordinate", "X:=", 63.66, "Y:=", 0.680489), Array(_
  "NAME:Coordinate", "X:=", 79.57, "Y:=", 0.819107), Array("NAME:Coordinate", _
  "X:=", 159.15, "Y:=", 1.24755), Array("NAME:Coordinate", "X:=", 318.3, _
  "Y:=", 1.51214), Array("NAME:Coordinate", "X:=", 477.46, "Y:=", 1.61291), _
  Array("NAME:Coordinate", "X:=", 636.61, "Y:=", 1.67586), Array(_
  "NAME:Coordinate", "X:=", 795.77, "Y:=", 1.71362), Array("NAME:Coordinate", _
  "X:=", 1591.5, "Y:=", 1.81417), Array("NAME:Coordinate", "X:=", 3183, "Y:=", _
  1.91447), Array("NAME:Coordinate", "X:=", 4774.6, "Y:=", 1.98956), Array(_
  "NAME:Coordinate", "X:=", 6366.1, "Y:=", 2.05205), Array("NAME:Coordinate", _
  "X:=", 7957.7, "Y:=", 2.10194), Array("NAME:Coordinate", "X:=", 15915, _
  "Y:=", 2.26316), Array("NAME:Coordinate", "X:=", 31830, "Y:=", 2.38398), _
  Array("NAME:Coordinate", "X:=", 111407, "Y:=", 2.48398), Array(_
  "NAME:Coordinate", "X:=", 190984, "Y:=", 2.58398), Array("NAME:Coordinate", _
  "X:=", 350138, "Y:=", 2.78398), Array("NAME:Coordinate", "X:=", 509292, _
  "Y:=", 2.98398), Array("NAME:Coordinate", "X:=", 2.10083e+06, "Y:=", _
  4.98398))), Array("NAME:core_loss_type", "property_type:=", _
  "ChoiceProperty", "Choice:=", "Electrical Steel"), "core_loss_kh:=", _
  130.296, "core_loss_kc:=", 1.03158, "core_loss_ke:=", 1.53217, _
  "conductivity:=", 1.96e+06, "mass_density:=", 9640.56) 
end if
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.327_N")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.327_N", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.32649", "conductivity:=", "0", _
...
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.327_S")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.327_S", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.32649", "conductivity:=", "0", _
  "mass_density:=", "0", Array("NAME:magnetic_coercivity", "property_type:=", _
  "VectorProperty", "Magnitude:=", "-690015A_per_meter", "DirComp1:=", "-1", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "M19_24G_2DSF1.260", "SolveInside:=", true) 
On Error Resume Next
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/Band", "Version:=", "12.1", "NoOfParameters:=", 7, _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "PartCoordinateSystem:=", "Global", "MaterialName:=", "M19_24G_2DSF1.260", _
  "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Global", "MaterialName:=", "XG196/96_2DSF1.327_N", "SolveInside:=", true) 
On Error Resume Next
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "1844.97rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.000674208, _
  "Load Torque:=", "if(speed<97.4655, -0.0579313*speed, -550.319/speed)", _
  "Objects:=", Array("Band"))
