...
if (oDefinitionManager.DoesMaterialExist("M19_24G_2DSF1.235")) then
else
oDefinitionManager.AddMaterial Array("NAME:M19_24G_2DSF1.235", _
  "CoordinateSystemType:=", "Cartesian", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), Array("NAME:permeability", "property_type:=", _
  "nonlinear", "HUnit:=", "A_per_meter", "BUnit:=", "tesla", Array(_
  "NAME:BHCoordinates", Array("NAME:Coordinate", "X:=", 0, "Y:=", 0), Array(_
  "NAME:Coordinate", "X:=", 22.28, "Y:=", 0.0617434), Array("NAME:Coordinate", _
  "X:=", 25.46, "Y:=", 0.123492), Array("NAME:Coordinate", "X:=", 31.83, _
  "Y:=", 0.185241), Array("NAME:Coordinate", "X:=", 47.74, "Y:=", 0.444586), _
  Array("NAME:Coordinate", "X:=", 63.66, "Y:=", 0.666881), Array(_
  "NAME:Coordinate", "X:=", 79.57, "Y:=", 0.802727), Array("NAME:Coordinate", _
  "X:=", 159.15, "Y:=", 1.2226), Array("NAME:Coordinate", "X:=", 318.3, "Y:=", _
  1.48191), Array("NAME:Coordinate", "X:=", 477.46, "Y:=", 1.58066), Array(_
  "NAME:Coordinate", "X:=", 636.61, "Y:=", 1.64236), Array("NAME:Coordinate", _
  "X:=", 795.77, "Y:=", 1.67937), Array("NAME:Coordinate", "X:=", 1591.5, _
  "Y:=", 1.77793), Array("NAME:Coordinate", "X:=", 3183, "Y:=", 1.87626), _
  Array("NAME:Coordinate", "X:=", 4774.6, "Y:=", 1.94989), Array(_
  "NAME:Coordinate", "X:=", 6366.1, "Y:=", 2.01117), Array("NAME:Coordinate", _
  "X:=", 7957.7, "Y:=", 2.0601), Array("NAME:Coordinate", "X:=", 15915, "Y:=", _
  2.2183), Array("NAME:Coordinate", "X:=", 31830, "Y:=", 2.3371), Array(_
  "NAME:Coordinate", "X:=", 111407, "Y:=", 2.4371), Array("NAME:Coordinate", _
  "X:=", 190984, "Y:=", 2.5371), Array("NAME:Coordinate", "X:=", 350138, _
  "Y:=", 2.7371), Array("NAME:Coordinate", "X:=", 509292, "Y:=", 2.9371), _
  Array("NAME:Coordinate", "X:=", 2.10083e+06, "Y:=", 4.9371))), Array(_
  "NAME:core_loss_type", "property_type:=", "ChoiceProperty", "Choice:=", _
  "Electrical Steel"), "core_loss_kh:=", 132.955, "core_loss_kc:=", 1.05263, _
  "core_loss_ke:=", 1.54773, "conductivity:=", 1.96e+06, "mass_density:=", _
  9447.75) 
end if
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.300_N")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.300_N", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.29996", "conductivity:=", "0", _
...
if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.300_S")) then
else
oDefinitionManager.AddMaterial Array("NAME:XG196/96_2DSF1.300_S", _
  "CoordinateSystemType:=", "Cylindrical", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.29996", "conductivity:=", "0", _
  "mass_density:=", "0", Array("NAME:magnetic_coercivity", "property_type:=", _
  "VectorProperty", "Magnitude:=", "-690015A_per_meter", "DirComp1:=", "-1", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "M19_24G_2DSF1.235", "SolveInside:=", true) 
On Error Resume Next
On Error Goto 0
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  "DllName:=", "RMxprt/Band", "Version:=", "12.1", "NoOfParameters:=", 7, _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "PartCoordinateSystem:=", "Global", "MaterialName:=", "M19_24G_2DSF1.235", _
  "SolveInside:=", true) 
On Error Resume Next
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Global", "MaterialName:=", "XG196/96_2DSF1.300_N", "SolveInside:=", true) 
On Error Resume Next
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "1818.29rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.00068574, _
  "Load Torque:=", "if(speed<96.16, -0.0595173*speed, -550.341/speed)", _
  "Objects:=", Array("Band"))
