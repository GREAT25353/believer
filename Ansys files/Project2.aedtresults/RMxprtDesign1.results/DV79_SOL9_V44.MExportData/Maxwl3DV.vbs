...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Value:=", "157.3112365985873mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "157.3112365985873mm"), Array("NAME:Pair", "Name:=", "InfoCore", "Value:=", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  Array("NAME:Pair", "Name:=", "LenRegion", "Value:=", "157.3112365985873mm"), _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "LenRegion", "Value:=", "157.3112365985873mm"), Array("NAME:Pair", "Name:=", _
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "1575.32rpm", "Moment of Inertia:=", 0.00149257, "Damping:=", 0.000748152, _
  "Load Torque:=", "if(speed<76.815, -0.0932116*speed, -549.998/speed)", _
  "Objects:=", Array("Band"))
